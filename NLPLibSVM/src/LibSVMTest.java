...
public class LibSVMTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] trainArgs = {"data/svm_train.txt"};//directory of training file
		String modelFile = svm_train.main(trainArgs);
		String[] testArgs = {"data/svm_test.txt", modelFile, "data/svm_result.txt"};//directory of test file, model file, result file
